...
const veryOldInventors = inventors.filter((element) => {
    return element.year >1500 && element.year <1599;
});
...
//const getFirstLastName = () => {
  //loop the array using .map
// let first = element.first
//const getFirstLastNames = () => {}
const inventorNames = inventors.map((element) => {
...
const sortedByBirthYear = inventors.sort((elementA, elementB) => {
...
const inventorNamedAda = inventors.find((element) => {
...
// const splitName = people.split((" ") => {
//  console.log(splitName[1])
// });

const splitNames = people.map((person) => {
...
console.log('Exercise 5 my result: ', splitNames);
...
const isAdultPresent = devs.some((element) => {
...
const commentById = comments.find((element) => {
